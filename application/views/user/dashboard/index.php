...
$restricted_code=array('4VJPWHRH+6V','4VJPWHRH+4V');
$this->db->select('code');
$this->db->select('prize');
			...
			<div class="page-content">
				...
				<div class="row">
					...
					<div class="col-xl-8 mx-autos">
						<h6 class="text-uppercase">Buy Virtual Land </h6>
            <input
      id="pac-input"
      class="controls"
      type="text"
...
for (var key in plist) 
{
   ...
   markers1.push(new google.maps.Marker({
        ...
        position: current,
        title: code,
        label:  {text: cost, color:"white", className: "labels1"},
        icon: image,
...
function drawsqual(map, code, fill) 
{
  ...
  return rectangle;  
       ...
       {
        othermsg('<h4 style="color:red;">You can\'t Buy this land. this land is allready sold or restriscted</h4>');
        return false;
       }
       else
       {
       ...
       else
       {
        ...
        $.ajax({ //Process the form using $.ajax()
            ...
            url       : '<?=base_url("ajaxusermaprate")?>', //Your form processing file URL
  ...
  <script type="text/javascript">
     ...
     google.maps.event.addDomListener(window, 'load', function() {
      ...
      map.setTilt(0);
      var zoomopt = { minZoom: <?=$zoom-($zoom-1)?>, maxZoom: <?=$zoom+2?> }; map.setOptions(zoomopt);
